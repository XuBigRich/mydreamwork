 ...
 */
package cn.piao888.mydreamwork.service;
...
public interface UserAuthService {
     ...
     * @param roleId 角色id
     */
    List<Privilege> findPermissionsByRoleId(Integer roleId);

    /**
     * 通过权限id获取 相关权限
     *
     * @param Permissions 角色bean
     */
    List<String> findPermissionsByPermissionId(Privilege Permissions);
